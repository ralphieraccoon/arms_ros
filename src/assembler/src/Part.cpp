...
std::shared_ptr<Polyhedron> Part::createNegative(std::shared_ptr<Polyhedron> substrate)
{
    return std::shared_ptr<Polyhedron>(new Polyhedron());

    // // Convert Polyhedra to Nef Polyhedra
    // Nef_polyhedron nef_substrate(substrate);
